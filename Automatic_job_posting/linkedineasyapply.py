...
class LinkedinEasyApply:
    ...
    def login(self):
        try:
            ...
            self.browser.find_element(By.XPATH,"//input[@id = 'username']").send_keys(self.email)
    ...
    def start_applying(self):
        ...
        page_sleep = 0
        minimum_time = 1*15 #antes era 60*15
            ...
            try:
                while True:
                    ...
                    if time_left > 0:
                        ...
                        minimum_page_time = time.time() + minimum_time
                    if page_sleep % 5 == 0:
                        sleep_time = random.randint(10, 20) #antes era de 500 a 900
        ...
        try:
            ...
            if len(groups) > 0:
                for group in groups:
                    ...
                    print("Input field name: " , input_field )
                    if 'street' in lb:
